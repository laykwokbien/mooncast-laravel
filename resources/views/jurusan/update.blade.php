...
<form class='flex flex-col w-100' action={{ route('jurusan.update', ['id'=>$data->id]) }} method="POST">
    @csrf
    <div class="flex flex-row gap-5 w-dvh">
        <div class="mb-3">
            <label for="nama_jurusan">Nama Jurusan: </label>
            <input type="text" name="nama_jurusan" id="nama_jurusan" placeholder="Enter input...." value="{{$data['nama_jurusan']}}">
            @error('nama_jurusan')
